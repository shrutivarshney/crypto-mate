const Banner = () => {
    return (
        <div className="py-4 bg-opacity-60 bg-custom-blue">
            <div className="grid py-8 mx-8 md:mx-16 md:gap-4 md:grid-cols-3 place-items-center">
                <div className="lg:col-span-2 md:col-span-3">
                    <p className="text-xl font-bold leading-10 sm:text-3xl md:text-5xl text-custom-green">World's Limitless Cryptocurrrency Exchange</p>
